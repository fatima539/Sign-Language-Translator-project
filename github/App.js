...
import RoadEmergency from "./screens/RoadEmergency";
import GeneralEmergency from "./screens/GeneralEmergency";
  ...
  return (
    <ThemeProvider>
      <NavigationContainer>
        ...
        <Stack.Screen name="RoadEmergency" component={RoadEmergency} />
        <Stack.Screen name="GeneralEmergency" component={GeneralEmergency} />
